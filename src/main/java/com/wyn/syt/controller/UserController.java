...
import com.wyn.syt.dto.UserDto;
import com.wyn.syt.entity.User;
import com.wyn.syt.service.UserService;
import com.wyn.syt.utils.SMSUtils;
import com.wyn.syt.utils.ValidateCodeUtils;
...
public class UserController {
    ...
    public R<String> sendMsg(@RequestBody User user, HttpSession session){
        ...
        if(StringUtils.isNotEmpty(phone)){
            ...
            SMSUtils.sendMessage("聚好吃一学习自用","SMS_274760164",phone,code);
